...
from trainer.trainer_utils import Logger, is_main_process, lm_checkpoint, init_distributed_mode, setup_seed, SkipBatchSampler, init_model, resolve_reward_model_path
...
if __name__ == "__main__":
    ...
    args.reward_model_path = resolve_reward_model_path(args.reward_model_path)
